...
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:00:00', 0, 0, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:00:30', 0, 30, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:01:00', 1, 0, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:01:30', 1, 30, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:02:00', 2, 0, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:02:30', 2, 30, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:03:00', 3, 0, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:03:30', 3, 30, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:04:00', 4, 0, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:04:30', 4, 30, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:05:00', 5, 0, false, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('AM:05:30', 5, 30, false, now(), now());
...
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:12:00', 12, 0, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:12:30', 12, 30, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:01:00', 13, 0, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:01:30', 13, 30, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:02:00', 14, 0, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:02:30', 14, 30, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:03:00', 15, 0, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:03:30', 15, 30, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:04:00', 16, 0, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:04:30', 16, 30, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:05:00', 17, 0, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:05:30', 17, 30, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:06:00', 18, 0, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:06:30', 18, 30, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:07:00', 19, 0, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:07:30', 19, 30, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:08:00', 20, 0, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:08:30', 20, 30, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:09:00', 21, 0, true, now(), now());
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:09:30', 21, 30, true, now(), now());
...
insert into booking_time (code, hour, minute, bookable, created_date, modified_date) values ('PM:11:30', 23, 30, false, now(), now());
